"""
Module for asynchronously managing individual stemming dictionaries in Typesense.
...
class StemmingDictionary:
    ...
    def _endpoint_path(self) -> str:
        ...
        """
        from typesense.async_client.stemming_dictionaries import StemmingDictionaries
