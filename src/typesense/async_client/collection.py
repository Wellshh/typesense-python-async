"""
This module provides functionality for asynchronously managing individual collections in the Typesense API,
which is a re-implementation of the `collection.py` module.
...
from typesense.async_client.overrides import Overrides
from typesense.async_client.synonyms import Synonyms
...
class Collection(typing.Generic[TDoc]):
    """
    Manages operations on a single collection in the Typesense API asynchronously.
