"""
This module provides functionality for asynchronously managing collections in the Typesense API.

It contains the Collections class, which allows for asynchronously creating, retrieving, and
accessing individual collections.

Classes:
    Collections: Manages collections in the Typesense API asynchronously.
...
class Collections(typing.Generic[TDoc]):
    """
    Manages collections in the Typesense API asynchronously.
    ...
    async def __contains__(self, collection_name: str) -> bool:
        ...
        try:
            await Collection(self.api_call, collection_name).retrieve()
            return True
        except Exception:
            return False
    ...
    async def create(self, schema: CollectionCreateSchema) -> CollectionSchema:
        """
        Create a new collection in Typesense asynchronously.
    ...
    async def retrieve(self) -> typing.List[CollectionSchema]:
        """
        Retrieve all collections from Typesense asynchronously.
