"""
This module provides functionality for making asynchronous API calls to a Typesense server,
which is a re-implementation of the `api_call.py` module.

It contains the AsyncApiCall class, which is responsible for executing HTTP requests
to the Typesense API, handling retries, and managing node health.

Key features:
- Support for asynchronous GET, POST, PUT, PATCH, and DELETE HTTP methods
- Automatic retries on server errors
- Node health management
- Type-safe request execution with overloaded methods

Classes:
    AsyncApiCall: Manages asynchronous API calls to the Typesense server.
...
from typesense.async_client.async_request_handler import AsyncRequestHandler
from typesense.async_client.async_request_handler import SessionFunctionKwargs
...
_SERVER_ERRORS: typing.Final[
    typing.Tuple[
        ...
        typing.Type[httpx.HTTPStatusError],
        typing.Type[httpx.RequestError],
        typing.Type[httpx.ConnectError],
        typing.Type[httpx.RemoteProtocolError],
...
class AsyncApiCall:
    """
    Manages asynchronous API calls to the Typesense server.
    ...
    Attributes:
        ...
        request_handler (AsyncRequestHandler): Handles the execution of individual requests.
    """
    ...
    def __init__(self, config: Configuration):
        ...
        self.request_handler = AsyncRequestHandler(config)
        self.httpx_session = httpx.AsyncClient(verify=config.verify)
    ...
    async def post(
        ...
        """
        Execute an asynchronous POST request to the Typesense API.
    ...
    async def put(
        ...
        """
        Execute an asynchronous PUT request to the Typesense API.
    ...
    async def patch(
        ...
        """
        Execute an asynchronous PATCH request to the Typesense API.
    ...
    async def delete(
        ...
        """
        Execute an asynchronous DELETE request to the Typesense API.
    ...
    async def _execute_request(
        ...
        **kwargs: SessionFunctionKwargs[TParams, TBody],
        ...
        """
        Execute an asynchronous request to the Typesense API with retry logic.
