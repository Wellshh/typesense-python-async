"""
This module provides functionality for asynchronously managing synonyms in Typesense.
...
from typesense.async_client.synonym import Synonym
...
class Synonyms:
    ...
    def __init__(self, api_call: AsyncApiCall, collection_name: str):
        """
