...
# Add a document
document = {"id": "1", "title": "The Hunger Games", "ratings_count": 200}
...
scoped_search_key = client.keys.generate_scoped_search_key(
    key["value"], {"filter_by": "ratings_count:<100"}
)
print(scoped_search_key)

# Search collection
print(
    search_client.collections["key_collection"].documents.search(
...
print(
    scoped_search_client.collections["key_collection"].documents.search(
        {
            "q": "hunger",
            "query_by": "title",
